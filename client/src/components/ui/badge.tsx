  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-400 focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        destructive:
          "border-transparent bg-red-600 text-zinc-50 shadow hover:bg-red-500 dark:bg-red-700",
        success:
          "border-transparent bg-green-600 text-zinc-50 shadow hover:bg-green-500 dark:bg-green-700",
